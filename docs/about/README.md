...
Module 17 is a new, DV modem designed for use with a 9600-baud capable FM analog
radio. Think of it like a 'smart-mic', where your voice goes in, and DV baseband
comes out. And, vice-versa - digital signals come into the radio, and analog
voice comes out of the modem. It's as simple as that!

Module17 is developed by the M17 Project as an easy-to-use way of utilizing the
M17 Protocol over RF using equipment that you may already have.
